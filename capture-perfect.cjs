...
async function main() {
  ...
  await page.screenshot({ path: path.join(outDir, '07-collection-chargee.jpg'), type: 'jpeg', quality: 95 });
  ...
  await sleep(2500);
  await page.screenshot({ path: path.join(outDir, '08-fiche-produit-ouverte.jpg'), type: 'jpeg', quality: 95 });
  ...
  await sleep(2000);
  await page.screenshot({ path: path.join(outDir, '09-panier-rempli.jpg'), type: 'jpeg', quality: 95 });
  ...
  await page.screenshot({ path: path.join(outDir, '10-bouton-commande.jpg'), type: 'jpeg', quality: 95 });
