...
async function main() {
  ...
  await page.goto("http://localhost:3000/boutique", {
    waitUntil: "domcontentloaded",
    timeout: 15000,
  });
  await sleep(2000);
  await page.screenshot({
    path: path.join(outDir, "01-collection.jpg"),
    type: "jpeg",
    quality: 95,
  });
  ...
  await sleep(1000);
  await page.screenshot({
    path: path.join(outDir, "02-scroll-collection.jpg"),
    type: "jpeg",
    quality: 95,
  });
  ...
  await sleep(2000);
  await page.screenshot({
    path: path.join(outDir, "03-fiche-produit.jpg"),
    type: "jpeg",
    quality: 95,
  });
  ...
  await sleep(1000);
  await page.screenshot({
    path: path.join(outDir, "04-fiche-produit-zoom.jpg"),
    type: "jpeg",
    quality: 95,
  });
  ...
  await page.screenshot({
    path: path.join(outDir, "06-bouton-whatsapp.jpg"),
    type: "jpeg",
    quality: 95,
  });
