...
export const Route = createFileRoute("/a-propos")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Découvrez l'histoire d'Al Kareem Parfumerie, une maison de parfum née à Cotonou, portée par la passion et le conseil personnalisé." },
    ...
    <SiteLayout>
      <section className="bg-gradient-hero">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 py-14 md:py-24 text-center">
          ...
          <h1 className="font-serif text-3xl sm:text-4xl md:text-6xl text-primary-deep">Une maison de parfum née à Cotonou</h1>
      ...
      <section className="mx-auto max-w-6xl px-4 sm:px-6 py-14 md:py-16 grid gap-8 md:gap-12 md:grid-cols-2 items-center">
        <img src={boutique} alt="Notre boutique" width={1200} height={800} loading="lazy" className="rounded-3xl shadow-elegant object-cover w-full aspect-[4/3]" />
        <div className="min-w-0">
          <div className="text-xs uppercase tracking-widest text-primary mb-2">Notre engagement</div>
          <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl text-primary-deep mb-4">Le conseil, la qualité, l'attention</h2>
          ...
          <p className="text-foreground/75 leading-relaxed">
            De la boutique physique de Cotonou aux commandes WhatsApp qui nous parviennent depuis tout le Bénin, notre priorité reste la même : le conseil sincère et l'attention portée à chaque détail.
          </p>
        </div>
      </section>
      ...
      <section className="bg-secondary">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 py-14 md:py-16">
          <div className="text-center mb-10 md:mb-12">
            ...
            <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl text-primary-deep">Ce qui nous guide</h2>
          </div>
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              { icon: Sparkles, title: "Qualité", desc: "Une sélection contrôlée, des produits authentiques uniquement." },
              { icon: Users, title: "Conseil", desc: "Un accompagnement personnalisé, en boutique comme en ligne." },
              { icon: Heart, title: "Chaleur", desc: "Un accueil sincère, parce que chaque client(e) compte pour nous." },
            ].map((v) => (
