...
function HomePage() {
  ...
  return (
    <SiteLayout hideFooter>
      {/* 1. HERO PRESTIGE AVEC IMAGE DE LA FEMME SE PARFUMANT EN ARRIÈRE-PLAN */}
      <section className="relative overflow-hidden bg-primary-deep text-white border-b border-border/60 py-16 sm:py-24 md:py-32">
        {/* Image de fond : Femme se parfumant */}
        <div className="absolute inset-0 z-0">
          ...
          />
          {/* Overlay dégradé sombre violet/or pour une lisibilité parfaite */}
          <div className="absolute inset-0 bg-gradient-to-r from-primary-deep/95 via-primary-deep/80 to-primary-deep/60" />
          <div className="absolute inset-0 bg-gradient-to-t from-primary-deep via-transparent to-primary-deep/40" />
        </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl space-y-6">
            ...
            <p className="text-sm sm:text-lg text-white/90 max-w-2xl leading-relaxed font-light">
              Laissez votre sillage révéler l'élégance qui est en vous. Explorez notre univers de 
              <strong> plus de 100 fragrances authentiques</strong>, huiles concentrées et coffrets d'exception 
              disponibles immédiatement à Cotonou.
            </p>
            ...
            {/* Badges de rassurance officiels */}
            <div className="flex flex-wrap items-center gap-3 pt-4">
              <div className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-black/40 backdrop-blur-md border border-white/20 text-xs font-medium text-white">
              ...
              <div className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-black/40 backdrop-blur-md border border-white/20 text-xs font-medium text-white">
                ...
                <span>Service Conseil Privé</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* 3. DIAGNOSTIC OLFACTIF INTERACTIF AVEC LES 4 FLACONS RECOMMANDÉS (SEULE GRILLE DE 4 CONSERVÉE) */}
